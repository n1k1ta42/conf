        ...
        <div className='modal-box relative w-11/12 max-w-5xl '>
          ...
          <article className='prose-xl'>
            ...
            <p>
              ...
              персональных данных, предпринимаемые Легким Юрием Юрьевичем (далее
              – Оператор).
            </p>
            <p>
            ...
            <p>
              2.10. Пользователь – любой посетитель веб-сайта https://yamal.dev.
            </p>
            <p>
            ...
            <p>
              ...
              информирование Пользователя посредством отправки сообщений
            ...
            <p>
              ...
              адрес электронной почты danver.cc.14@yandex.ru с пометкой «Отказ
            ...
            <p>
              ...
              Оператором являются: – федеральные законы, иные
            ...
            <p>
              ...
              через специальные формы, расположенные на сайте https://yamal.dev
            ...
            <p>
              ...
              Оператора danver.cc.14@yandex.ru с пометкой «Актуализация
              персональных данных».
            </p>
            <p>
              ...
              danver.cc.14@yandex.ru с пометкой «Отзыв согласия на обработку
              персональных данных».
            </p>
            <p>
          ...
          <div className='modal-action'>
            <label htmlFor='privacy' className='btn-secondary btn'>
              Готово
            </label>
          </div>
        </div>
